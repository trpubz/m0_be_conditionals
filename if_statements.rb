...
num_quarters >= 2 ? puts("I have enough money for a gumball") : puts("I don't have enough money for")
...
cups_of_flour >= 2 && has_sauce ? puts("I can make pizza") : puts("I cannot make pizza")
